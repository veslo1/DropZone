...
?>
    ...
    <link rel="stylesheet" id="css-hiveframe" href="<?php echo $one->assets_folder; ?>/css/hiveframe.css" />
    <link rel="stylesheet" id="css-custom" href="<?php echo $one->assets_folder; ?>/css/custom.css">
